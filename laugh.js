...
var newJokeButton = document.getElementById('display-button');
...
// function showJoke(){
//   makeUniqueJokeFromArray();
//   insertJoke = allJokes[newJokesArray[0]];
//   allJokes[newJokesArray[0]].views += 1;
// }

//hides play game button until first joke is viewed
// document.getElementById('ready-to-play').style.visibility = 'hidden';

// function eventHandler(event){
//   event.preventDefault();
//   console.log('clicked on this thing');
//   // showJoke();
//   clickCounter += 1;
//     console.log(clickCounter, 'total clicks so far');
//
...
//   }
  ...
  //Local storage stuff goes here
// }
//
// // showJoke();
//
// //function to check for local storage goes here
//
