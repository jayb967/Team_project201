...
function getRandJoke(){
  var i = Math.floor(Math.random() * (maxJokes - 1));
  return jokes[i];
}
// document.getElementById('jokes').innerHTML = getRandJoke;



function JokesConst(joke){
  this.joke = joke;
  this.views
  newJokesArray.push(this)
}

// JokesConst.prototype.generateNewJoke = function(){
//   for (var i = 0; i < jokes.length; i++){
//     var newJokes = Math.floor(Math.random() * generateNewJoke)
//   }
// }
